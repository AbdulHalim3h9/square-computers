...
export default function Navbar({ className = '' }) {
  ...
  const navbarClasses = useMemo(
    () => `w-full bg-white shadow-lg shadow-cyan-100/20 transition-all duration-300 ease-out ${scrolled ? 'shadow-md' : 'shadow-sm'} ${className}`,
    [scrolled, className]
  );
  ...
  return (
    <>
      ...
      <nav className={`${navbarClasses} h-16`} style={{ position: 'relative', zIndex: 40 }}>
        <div className="mx-auto px-4 h-full">
          <div className="flex items-center h-20 px-4 md:px-6 lg:px-8">
