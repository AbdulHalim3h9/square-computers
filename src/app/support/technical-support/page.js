      ...
      <section className="max-w-6xl mx-auto px-4 py-10">
        <div className="bg-gradient-to-br from-cyan-500/10 to-cyan-600/5 p-8 rounded-lg text-center border border-cyan-500/20 cyan-glow support-text">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/contact"
              className="inline-block bg-gradient-to-r from-cyan-500 to-cyan-600 text-white py-2 px-6 rounded-lg hover:from-cyan-600 hover:to-cyan-700 transition-all duration-200 text-sm"
            >
              Contact Support
            </Link>
            <Link
              href="tel:+8801988999916"
              className="inline-block bg-gradient-to-r from-gray-700 to-gray-800 text-white py-2 px-6 rounded-lg hover:from-gray-800 hover:to-gray-900 transition-all duration-200 text-sm"
            >
