export const menuItems = [
  ...
  },
  {
    ...
    requiresAuth: true,
    specialClass: 'bg-gradient-to-r from-cyan-600 to-cyan-800 text-white hover:from-cyan-700 hover:to-cyan-900 hover:translate-x-2 transition-all duration-300',
    icon: (
  ...
  },
  {
    title: 'Login',
    href: '/login',
    iconOnly: true, // Flag to indicate this should only show icon
    icon: (
